...
object LyricsImportSecurity {
    ...
    fun validateImportedLrcContent(rawText: String): LyricsImportValidationResult {
        ...
        // LOCAL PATCH (not upstream). Upstream calls LyricsUtils.parseLyrics here,
        // which pulls in kuromoji and pinyin4j to romanize Japanese and Chinese
        // lyrics — a lot of weight for a path that is unreachable in this companion
        // (there is no lyrics provider). Fail closed instead.
